...
<a data-toggle='modal' href='#modal4".$it."' class='text-muted' data-toggle='tooltip' data-placement='top' title='Add To Maintenance'><i class='icofont icofont-meeting-add'></i></a>
</td>
</tr>";
...
echo "<td class='action-icon'>
<a data-toggle='modal' href='#modal2".$it."' class='text-muted' data-toggle='tooltip' data-placement='top' title='Remove Item'><i class='icofont icofont-delete-alt'></i></a>
<a data-toggle='modal' href='#modal3".$it."' class='text-muted' data-toggle='tooltip' data-placement='top' title='Add Quantity'><i class='icofont icofont-plus'></i></a>
</td>
</tr>";
